...
messageToSendUser += "<a style='padding-right:10px;' href='https://api.whatsapp.com/send?phone=18004256402' target='_blank'><img alt='Whatsapp' src='http://hotelmemberships.com/social-thanku-ico/whtsap.png' style='border-width:0;Margin: 0 auto;display: inline-block;padding:10px;vertical-align: middle;height: auto;' title='Share on Whatsapp' width='32'></a></td>"
messageToSendUser += "</tr>"
messageToSendUser += "<tr>"
...
messageToSendUser += "</table>"
  messageToSendUser += "</div>"
            ...
            'TLCMessage.CC.Add(New Net.Mail.MailAddress("bhanu.manral@tlcgroup.com", "bhanu.manral@tlcgroup.com"))
            ...
            TLCMessage.Subject = "Request a Call – HM Organic"
