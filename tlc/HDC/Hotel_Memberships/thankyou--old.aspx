...
<div style="max-width:650px;" class="thankyou-cont">
  <div class="sub-bg">
    <div class="row">
      ...
      <img src="http://hotelmemberships.com/app/themes/hm-v03/assets/images/logo.png" class="img-responsive"> 
      </div>
      </div>
    </div>
  </div>
    ...
    <div class="row thankyou-body">
      <div class="col-md-12">
        ...
        <p>Thank you for dropping your details and showing interest in becoming a member of a luxury hotel. Our Membership Process Executive will call you within 24 hours on the given contact details to help you get the best membership near you.</p>
  ...
  <div class="footer-cont"> <a href="http://www.hotelmemberships.com" target="_blank">Website</a><span> | </span><a href="http://hotelmemberships.com/privacy-policy/" target="_blank">Privacy Policy</a>
    <p>© 2017 TLC® Relationship Management Pvt. Ltd. All Rights Reserved.</p>
    <div class="thankyou-social">
      <ul>
        ...
        <li class="i-whatsapp"> <a href="https://api.whatsapp.com/send?phone=18004256402" target="_blank"></a> </li>
      </ul>
    </div>
  </div>
</div>
...
<!-- End Facebook Pixel Code -->
    <script type="text/javascript">
        window.setTimeout(function () {
            ...
            window.location.href = "http://www.hotelmemberships.com";
        }, 5000);
    </script>
