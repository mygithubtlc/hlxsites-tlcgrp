                        ...
                        messageToSendUser += "<table cellspacing='0' cellpadding='0' width='600' border='0' bgcolor='#FFF' style='color:#000;'> "
                            ...
                            messageToSendUser &= "<tr>"
                                messageToSendUser &= "<td style='padding-top:20px;' align='left' width='300'>"
                                    messageToSendUser &= "<a href='https://www.theleela.com/the-leela/Loyalty/connoisseur-club/Connoisseur%20Club%20The%20Leela%20Mumbai%20Membership%20Benefits.pdf' target='_blank'><img src='https://www.tlcgroup.com/tlc/landing_page/ConnoisseurClub/LeelaMumbai/images/conn-logo.png' style='width:'200' border='0' alt=''></a>"
                                messageToSendUser &= "</td>"
...
TLCstr &= "<table border='1' width='500px'>"
    ...
    TLCstr &= "<tr>"
        ...
        TLCstr &= "<tr>"
            TLCstr &= "<td>Source</td>"
            TLCstr &= "<td class='auto-style1'>Email Campaign</td>"
        TLCstr &= "</tr>"
        End If
        If strRac = "2" Then
        TLCstr &= "<tr>"
            ...
            <table max-width="650" align="center" cellpadding="5" cellspacing="0" style="margin:0 auto;">
                <tr style="text-align: left;">
                    <td  style="text-align: left; width:325px;">
                        <a href="https://www.theleela.com/the-leela/Loyalty/connoisseur-club/Connoisseur%20Club%20The%20Leela%20Mumbai%20Membership%20Benefits.pdf" target="_blank">
