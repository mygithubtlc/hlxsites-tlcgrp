...
<head runat="server">
    <title>Global Hospitality Conclave</title>
    <meta charset="utf-8">
    ...
    <script type="text/javascript">
        ...
        $.fn.checkInputProgramme = function () {
            //debugger;
            var resultText = "";
            var strCheckResult = $('#divAllProgrammeCheckbox input[type="checkbox"]:checked');
                    ...
                    <div id="divAllProgrammeCheckbox">
                        <div class="col-md-6">
                            <div class="checkbox">
                                <label>
                                    ...
                                    <asp:CheckBox ID="chkMangTrainee" Text="Management Trainee" runat="server" />
                        ...
                        <div class="col-md-6">
                            <div class="checkbox">
                                <label>
                                    <%--<input type="checkbox" value="">--%>
                                    <asp:CheckBox ID="chkHouseKeep" Text="House Keeping Trainee" runat="server" />
                        ...
                        <div class="col-md-6">
                            <div class="checkbox">
                                <label>
                                    <%--<input type="checkbox" value="">--%>
                                    <asp:CheckBox ID="chkKitchen" Text="Kitchen" runat="server" />
                        ...
                        <div class="col-md-6">
                            <div class="checkbox">
                                <label>
                                    <%--<input type="checkbox" value="">--%>
                                    <asp:CheckBox ID="chkKitStewarding" Text="Kitchen Stewarding" runat="server" />
                        ...
                        <div class="col-md-6">
                            <div class="checkbox">
                                <label>
                                    <%--<input type="checkbox" value="">--%>
                                    <asp:CheckBox ID="chkLeadership" Text="Leadership Role at The Oberoi Group for 10 years or more" runat="server" />
