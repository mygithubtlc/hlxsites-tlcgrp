                            ...
                            <div class="form">
                                <div class="form-group">
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <asp:TextBox ID="txtFName1" style="text-transform: capitalize;" runat="server" onkeypress="return isNameAlphabet(event);" CssClass="form-control" placeholder="First Name"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-6 form-group">
                            ...
                            <div class="form">
                                <div class="form-group">
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <asp:TextBox ID="txtFName2" style="text-transform: capitalize;" runat="server" onkeypress="return isNameAlphabet(event);" CssClass="form-control" placeholder="First Name"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-6 form-group">
