...
TLCMessage.Subject = "Hyatt Dining Club - Request A Call - Hyatt Centric Candolim Goa"
...
TLCstr &= "<table border='1' width='500px'>"
    ...
    TLCstr &= "<tr>"
        ...
        TLCstr &= "</td>"
        TLCstr &= " <td class='auto-style1'>Hyatt Centric Candolim Goa"
        TLCstr &= "</td>"
        TLCstr &= "<tr>"
            TLCstr &= "<td>Name"
            TLCstr &= "</td>"
        ...
        TLCstr &= "<tr>"
            TLCstr &= "<td>Source</td>"
            TLCstr &= "<td class='auto-style1'>Hyatt Centric Candolim Goa Mailer – July 2020</td>"
        TLCstr &= "</tr>"
        End If
        If strRac = "2" Then
        TLCstr &= "<tr>"
...
Dim strSubject As String = "Hyatt Dining Club - Request A Call - Hyatt Centric Candolim Goa"
...
Dim strUrl As String = "http://tlc.in/postpack/UserInformation.aspx?" + "Property=Hyatt Centric Candolim Goa&FirstName=" + txtName.Text + "&Mobile=" + txtMobile.Text + "&Email=" + txtEmailID1.Text + "&IPAddress=" + strIPAddress + "&DropSubject=" + strSubject + "&Source=" + strSource
...
<html lang="en">
<head>
    <title>Hyatt Dining Club | Hyatt Centric Candolim Goa</title>
    <meta charset="utf-8">
