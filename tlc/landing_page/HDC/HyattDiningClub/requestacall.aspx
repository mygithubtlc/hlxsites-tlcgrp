...
Message.Subject = "Thank You - Hyatt Dining Club"
           
            Dim pathToHTMLFile As String = Server.MapPath("~/hdcjoinnowthankyou.html")
            Dim messageToUser As String = File.ReadAllText(pathToHTMLFile)
            messageToUser = messageToUser.Replace("{{MemberName}}", StrConv(sClientName.Trim, VbStrConv.ProperCase))
            'Response.Write(messageToUser)
            ...
            TLCMessage.To.Add(New Net.Mail.MailAddress("drops@tlcgroup.com"))
            ...
            TLCMessage.Subject = "Hyatt Dining Club - Request A Call"
            ...
            TLCstr &= "</td>"
            TLCstr &= " <td class='auto-style1'>Hyatt Dining Club"
            TLCstr &= "</td>"
            TLCstr &= "<tr>"
            TLCstr &= "<td>Name"
            TLCstr &= "</td>"
            ...
            Dim strSubject As String = "Hyatt Dining Club - Request A Call"
...
Dim strUrl As String = "http://tlc.in/postpack/UserInformation.aspx?" + "Property=Hyatt Dining Club&FirstName=" + txtName.Text + "&Mobile=" + txtMobile.Text + "&Email=" + txtEmailID1.Text + "&IPAddress=" + strIPAddress + "&DropSubject=" + strSubject + "&Source=" + strSource
...
<html lang="en">
<head>
    <title>Hyatt Dining Club | Hyatt Dining Club</title>
    <meta charset="utf-8">
