...
<script runat="server">
    ...
    Protected Sub Submit1_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        message.From = New MailAddress("stargourmet@saharastar.com", "Star Gourmet") ''stargourmet@saharastar.com
        message.To.Add(New MailAddress("stargourmet@saharastar.com", "Star Gourmet"))
        ...
        message.CC.Add(New Net.Mail.MailAddress("shilpa.joshi@tlcgroup.com", "shilpa.joshi@tlcgroup.com"))
        ...
        message.Subject = "Star Gourmet - Refer A Friend"
...
<div class="container">
  <div class="row">
    <div class="col-sm-12"><p style="padding-top: 20px;">Thank you for participating in our Referral Program. This allows us to offer you benefits for recommending members. Please complete the table below with names and contact number of your friends and family who you believe dine out often enough and will benefit from the membership of Star Gourmet.</p></div>
  </div>
  <div class="row">
    <div class="col-sm-12">
        <ul>
            <li>For one (1) successful referral, we will send one certificate entitling the Bearer to a complimentary buffet lunch for two (2) guests.</li>
            <li>For three (3) successful referrals, we will send one certificate entitling the Bearer to a complimentary one night stay in the base category of rooms.</li>
            <li>For five (5) successful referrals, we will send an Star Gourmet Membership Package to any individual of your choice.</li>
            <li>For seven (7) successful referrals, we will send an Star Gourmet Membership Package to any individual of your choice.</li>
        </ul>
    </div>        
  </div>
</div>
          ...
          <div class="row">
            ...
            <img src="images/Header.jpg" alt="" />
                <p class="font-verdana" style="text-align: justify">
                        ...
                        <p class="font">Thank you for your interest in <span>Star Gourmet</span> !</p>
                      ...
                      <p class="font">Team <span >Star Gourmet</span></p>
                    </p>
                    <p class="Right">X</p>
