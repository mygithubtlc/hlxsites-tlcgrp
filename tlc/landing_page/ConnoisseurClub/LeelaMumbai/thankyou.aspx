    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () { 
            ...
            debugger;
                ...
                var TableReqhelpdeskNo = "+91 22 6691 1730 / 31";
                var TableReqEmail = "cclub.mumbai@theleela.com";
                $('#imgProgram').attr('src', '');
        ...
        <div class="">
            <div class="row" style="padding:15px; font-family:Arial;">
                <div class="col-md-12">
                    ...
                    <span style="color:#000 !important;">Phone: +91 22 6691 1730 / 31</span>
                    <br />
                    <span style="color:#000 !important; text-decoration:none;">E-mail: <a style="color:#000 !important; text-decoration:none;" href="mailto:cclub.mumbai@theleela.com">cclub.mumbai@theleela.com</a></span>
