                        ...
                        messageToSendUser += "<table cellspacing='0' cellpadding='0' width='600' border='0' bgcolor='#FFF' style='color:#000;'> "
                            ...
                            messageToSendUser &= "<tr>"
                                messageToSendUser &= "<td style='padding-top:20px;' align='left' width='300'>"
                                    messageToSendUser &= "<a href='https://www.tlc.in/TLC/leela/mumbai/Leela-Mumbai-SOB.pdf' target='_blank'><img src='https://www.tlcgroup.com/tlc/landing_page/ConnoisseurClub/LeelaMumbai/images/conn-logo.png' style='width:'200' border='0' alt=''></a>"
                                messageToSendUser &= "</td>"
                                messageToSendUser &= "<td style='padding-top:20px;' align='right' width='300'>"
                                    messageToSendUser &= "<a href='https://www.theleela.com/en_us/hotels-in-mumbai/the-leela-mumbai-hotel/' target='_blank'><img src='https://www.tlcgroup.com/tlc/landing_page/ConnoisseurClub/LeelaMumbai/images/leela-mumbai.jpg' style='width:'105' border='0' alt=''></a>"
                                messageToSendUser &= "</td>"
                            messageToSendUser &= "</tr>"
                            messageToSendUser &= "<tr>"
                                    ...
                                    messageToSendUser &= "<table cellspacing='0' cellpadding='0' border='0' width='650' style='font-size: 14px; text-align: justify;'>"
                                        ...
                                        messageToSendUser &= "<tr>   "
                                            messageToSendUser &= "<td style='text-align: justify;color:#000; padding-top: 15px;'>"
                                                ...
                                                messageToSendUser &= "<br>"
                                                messageToSendUser &= "<br>"
                                                messageToSendUser &= "Phone: +91 22 6691 1730 / 31"
                                                
                                                messageToSendUser &= "<br>"
                                                messageToSendUser &= "Email: <a href='mailto:cclub.mumbai@theleela.com' style='color:#000; text-decoration:none;'>cclub.mumbai@theleela.com</a>"
                                                messageToSendUser &= "</font>"
...
Dim TLCmailID As String = "cclub.mumbai@theleela.com" ' tlc Email id
...
TLCMessage.CC.Add(New Net.Mail.MailAddress("vinod.pillai@tlcgroup.com", "vinod.pillai@tlcgroup.com"))
TLCMessage.CC.Add(New Net.Mail.MailAddress("alka@tlcgroup.com", "alka@tlcgroup.com"))

TLCMessage.IsBodyHtml = True
TLCMessage.Subject = "Connoisseur Club - Request A Call - The Leela Mumbai"
...
TLCstr &= "<table border='1' width='500px'>"
    ...
    TLCstr &= "<tr>"
        ...
        TLCstr &= "</td>"
        TLCstr &= " <td class='auto-style1'>The Leela Mumbai"
        TLCstr &= "</td>"
        TLCstr &= "<tr>"
            TLCstr &= "<td>Name"
            TLCstr &= "</td>"
        ...
        TLCstr &= "<tr>"
            TLCstr &= "<td>Source</td>"
            TLCstr &= "<td class='auto-style1'>The Leela Mumbai Mailer – December 2019</td>"
        TLCstr &= "</tr>"
        End If
        If strRac = "2" Then
        TLCstr &= "<tr>"
...
Dim strSubject As String = "Connoisseur Club - Request A Call - The Leela Mumbai"
...
Dim strUrl As String = "http://tlc.in/postpack/UserInformation.aspx?" + "Property=The Leela Mumbai&FirstName=" + txtName.Text + "&Mobile=" + txtMobile.Text + "&Email=" + txtEmailID1.Text + "&IPAddress=" + strIPAddress + "&DropSubject=" + strSubject + "&Source=" + strSource
...
<html lang="en">
<head>
    <title>Connoisseur Club | The Leela Mumbai</title>
    <meta charset="utf-8">
            ...
            <table max-width="650" align="center" cellpadding="5" cellspacing="0" style="margin:0 auto;">
                <tr style="text-align: left;">
                    <td  style="text-align: left; width:325px;">
                        <a href="https://www.tlc.in/TLC/leela/mumbai/Leela-Mumbai-SOB.pdf" target="_blank">
