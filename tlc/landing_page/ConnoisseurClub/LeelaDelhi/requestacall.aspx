...
Dim FromEmail As New Net.Mail.MailAddress("contactus@connoisseurclub.in", "Connoisseur Club")
                ...
                messageToSendUser += "<tr> "
                    messageToSendUser += "<td colspan='' align='center'> "
                        messageToSendUser += "<table cellspacing='0' cellpadding='0' width='600' border='0' bgcolor='#FFF' style='color:#000;'> "
                            messageToSendUser += "<tr>  "
                                messageToSendUser += "<td align='center' colspan='2'>"
                                    messageToSendUser &= "<img src='https://tlcgroup.com/tlc/landing_page/ConnoisseurClub/LeelaMumbai/images/Header.jpg' style='width:'600' border='0' alt=''>"
                                messageToSendUser &= "</td>"
                            messageToSendUser &= "</tr>"
                            messageToSendUser &= "<tr>"
                                messageToSendUser &= "<td style='padding-top:20px;' align='left' width='300'>"
                                    messageToSendUser &= "<a href='https://www.theleela.com/the-leela/Loyalty/connoisseur-club/Connoisseur%20Club%20The%20Leela%20Ambience%20Convention%20Delhi%20Membership%20Benefits.pdf' target='_blank'><img src='https://www.tlcgroup.com/tlc/landing_page/ConnoisseurClub/LeelaMumbai/images/conn-logo.png' style='width:'200' border='0' alt=''></a>"
                                messageToSendUser &= "</td>"
                                messageToSendUser &= "<td style='padding-top:20px;' align='right' width='300'>"
                                    messageToSendUser &= "<a href='https://www.theleela.com/en_us/hotels-in-delhi/the-leela-ambience-convention-hotel-delhi/' target='_blank'><img src='https://www.tlcgroup.com/tlc/landing_page/ConnoisseurClub/LeelaMumbai/images/leeladelhi.jpg' style='width:'105' border='0' alt=''></a>"
                                messageToSendUser &= "</td>"
                            messageToSendUser &= "</tr>"
                            messageToSendUser &= "<tr>"
                                    ...
                                    messageToSendUser &= "<table cellspacing='0' cellpadding='0' border='0' width='650' style='font-size: 14px; text-align: justify;'>"
                                        ...
                                        messageToSendUser &= "<tr>"
                                            messageToSendUser &= "<td style='text-align: justify;color:#000; padding-top: 15px;'>"
                                                messageToSendUser &= "<font face='Arial, Helvetica, sans-serif'>Thank you for your interest in Connoisseur Club."
                                        ...
                                        messageToSendUser &= "<tr>   "
                                            messageToSendUser &= "<td style='text-align: justify;color:#000; padding-top: 15px;'>"
                                                ...
                                                messageToSendUser &= "<b>Team Connoisseur Club</b>"
                                                messageToSendUser &= "<br>"
                                                messageToSendUser &= "<br>"
                                                messageToSendUser &= "Phone: +91 11 4908 8662 / 63"
                                                
                                                messageToSendUser &= "<br>"
                                                messageToSendUser &= "Email: <a href='mailto:cclub.delhi@theleela.com' style='color:#000; text-decoration:none;'>cclub.delhi@theleela.com</a>"
                                                messageToSendUser &= "</font>"
...
Dim TLCmailID As String = "cclub.delhi@theleela.com" ' tlc Email id

Dim TLCFromEmail As New Net.Mail.MailAddress("contactus@connoisseurclub.in", "Connoisseur Club")
...
TLCMessage.CC.Add(New Net.Mail.MailAddress("vimal.karki@tlcgroup.com", "vimal.karki@tlcgroup.com"))

TLCMessage.IsBodyHtml = True
TLCMessage.Subject = "Connoisseur Club - Request A Call - The Leela Ambience Convention Hotel, Delhi"
...
TLCstr &= "<table border='1' width='500px'>"
    ...
    TLCstr &= "<tr>"
        ...
        TLCstr &= "</td>"
        TLCstr &= " <td class='auto-style1'>The Leela Ambience Convention Hotel, Delhi"
        TLCstr &= "</td>"
        TLCstr &= "<tr>"
            TLCstr &= "<td>Name"
            TLCstr &= "</td>"
        ...
        TLCstr &= "<tr>"
            TLCstr &= "<td>Source</td>"
            TLCstr &= "<td class='auto-style1'>Facebook_Organic</td>"
        TLCstr &= "</tr>"
        End If
        If strRac = "2" Then
        TLCstr &= "<tr>"
            TLCstr &= "<td>Source</td>"
            TLCstr &= "<td class='auto-style1'>Twitter_Organic</td>"
        TLCstr &= "</tr>"
        End If
        If strRac = "3" Then
        TLCstr &= "<tr>"
            TLCstr &= "<td>Source</td>"
            TLCstr &= "<td class='auto-style1'>Linkedin_Organic</td>"
        TLCstr &= "</tr>"
        End If
        If strRac = "4" Then
        TLCstr &= "<tr>"
    ...
    TLCstr &= "</table>"
    TLCstr &= "<br />"
    TLCstr &= "Team Connoisseur Club<br /><br />"
...
Dim strSubject As String = "Connoisseur Club - Request A Call - The Leela Ambience Convention Hotel, Delhi"
...
Dim strUrl As String = "http://tlc.in/postpack/UserInformation.aspx?" + "Property=The Leela Ambience Convention Hotel, Delhi&FirstName=" + txtName.Text + "&Mobile=" + txtMobile.Text + "&Email=" + txtEmailID1.Text + "&IPAddress=" + strIPAddress + "&DropSubject=" + strSubject + "&Source=" + strSource
...
<html lang="en">
<head>
    <title>Connoisseur Club | The Leela Ambience Convention Hotel, Delhi</title>
    <meta charset="utf-8">
    ...
    <div class="container" style="max-width: 600px; border: 1px solid black; padding: 0px 0px 20px 0px;">
        ...
        <div class="row pad">
            ...
            <div class="">
                <div class="row">
                    <%-- <div class="col-md-6">
                        <p>Connoisseur Club is your key to <b>more</b>. Much more. More tantalizing your taste buds, more indulging your senses and more entertaining your guests. As a Club Marriott member, you can enjoy these privileges - <b>and more</b> - even if you are not staying at our hotels.</p>
                        <ul>
