...
Dim FromEmail As New Net.Mail.MailAddress("velvetclub@tlcgroup.com", "Velvet Club")
                ...
                messageToSendUser += "<tr> "
                    messageToSendUser += "<td colspan='' align='center'> "
                        messageToSendUser += "<table cellspacing='0' cellpadding='0' width='600' border='0' bgcolor='#FFF' style='color:#000;'> "
                                messageToSendUser += "<tr>  "
                                messageToSendUser += "<td align='center'>"
                                    messageToSendUser += "<img src='https://www.tlcgroup.com/tlc/landing_page/velvetclub/lusaka/images/header.jpg' style='width:'600' border='0' alt=''>"
                                messageToSendUser += "</td>"
                            messageToSendUser += "</tr>"
                                messageToSendUser += "<tr>  "
                                    messageToSendUser += "<td colspan='3'>  "
                                        messageToSendUser += "<center>  "
                                    messageToSendUser += "<table cellspacing='0' cellpadding='0' border='0' width='600' style='font-size: 14px; text-align: justify;'>"
                                        messageToSendUser += "<tr> "
                                        ...
                                        messageToSendUser += "<tr> "
                                            messageToSendUser += "<td style='text-align: justify;color:#000; padding-top: 15px;'> "
                                                messageToSendUser &= "<font face='Arial, Helvetica, sans-serif'>Thank you for your interest in Velvet Club."
                                        ...
                                        messageToSendUser += "<tr> "
                                            ...
                                            messageToSendUser += "<td style='text-align: justify;color:#000; padding-top: 15px;'> "
                                                ...
                                                messageToSendUser += "<b>Team Velvet Club</b>"
                                                messageToSendUser += "<br>"
                                                messageToSendUser += "<br>"
                                                messageToSendUser += "Telephone: +260 97309 2211 / 1131"
                                                
                                                messageToSendUser += "<br>"
                                                messageToSendUser += "Email: <a href='mailto:velvetclub@tlcgroup.com' style='color:#000; text-decoration:none;'>velvetclub@tlcgroup.com</a><br/>Website: <a href=""https://www.velvetclubmembership.com/en/india"" style='color:#000; text-decoration:none;'>www.velvetclubmembership.com</a>"
                                                messageToSendUser += "</font> "
                                        ...
                                        messageToSendUser += "</tr> "
                                messageToSendUser += "</table>"
                                messageToSendUser += "<table cellspacing='0' cellpadding='0' border='0' width='600' bgcolor='#FFF' style='color:#000;'>"
                                    messageToSendUser += "<tr> "
...
Dim TLCMessage As New Net.Mail.MailMessage()
 ...
 Dim TLCmailID As String = "velvetclub@tlcgroup.com" ' tlc Email id
'Dim TLCmailID As String = "brijesh.gupta@tlcgroup.com"
 Dim TLCFromEmail As New Net.Mail.MailAddress("velvetclub@tlcgroup.com", "Velvet Club")
...
TLCMessage.Subject = "Velvet Club - Request A Call - Neelkanth Sarovar Premiere, Lusaka"
...
TLCstr &= "<table border='1' width='500px'>"
    ...
    TLCstr &= "<tr>"
        ...
        TLCstr &= "</td>"
        TLCstr &= " <td class='auto-style1'>Neelkanth Sarovar Premiere, Lusaka"
        TLCstr &= "</td>"
        TLCstr &= "<tr>"
            TLCstr &= "<td>Name"
            TLCstr &= "</td>"
...
Dim strSubject As String = "Velvet Club - Request A Call - Neelkanth Sarovar Premiere, Lusaka"
...
Dim strUrl As String = "http://tlc.in/postpack/UserInformation.aspx?" + "Property=Neelkanth Sarovar Premiere, Lusaka&FirstName=" + txtName.Text + "&Mobile=" + txtMobile.Text + "&Email=" + txtEmailID1.Text + "&IPAddress=" + strIPAddress + "&DropSubject=" + strSubject + "&Source=" + strSource
...
<html lang="en">
<head>
    <title>Velvet Club | Neelkanth Sarovar Premiere, Lusaka</title>
    <meta charset="utf-8">
    ...
    jAlert("Please accept Terms & Conditions.");
    return false;
    }
...
<body>
    <div class="container" style="max-width: 600px; border: 1px solid black; padding: 0px 0px 20px 0px;">
        ...
        <div class="row pad">
            ...
            <table max-width="650" align="center" cellpadding="5" cellspacing="0" style="margin:0 auto;">
                <tr style="text-align: left;">
                     ...
                     <a href="http://www.velvetclubmembership.com/" target="_blank">
                      <img src="images/velvet_club.png" width="146" style="max-width:100%; display: inline-block; min-width: 73px;">
                      </a> 
                    </td>
                    <td style=" text-align: right; width:325px;">
                    <a href="https://www.sarovarhotels.com/neelkanth-sarovar-premiere-lusaka/" target="_blank">
                      <img src="images/lusaka.png" width="146" style="max-width:100%; display: inline-block;">
                    </a>
                    </td>
                </tr>
</table>
        ...
        <div class="">
            <div class="row">
                <%-- <div class="col-md-6">
                    <p>Velvet Club is your key to <b>more</b>. Much more. More tantalizing your taste buds, more indulging your senses and more entertaining your guests. As a Club Marriott member, you can enjoy these privileges - <b>and more</b> - even if you are not staying at our hotels.</p>
                    <ul>
